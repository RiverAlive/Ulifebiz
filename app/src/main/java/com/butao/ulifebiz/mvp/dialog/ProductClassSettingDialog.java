 ...
 * 功能描述 ：
 */
public class ProductClassSettingDialog  {
    private Activity mActivity;
    private PopupWindow mPopupWindow;
    View contentView;
    public ProductClassSettingDialog() {
    }
    ProductListener productListener;
    public void setProductListener(ProductListener productListener) {
        this.productListener = productListener;
    }
    public ProductClassSettingDialog(Activity activity) {
        mActivity = activity;
        initview();
    }
    private void initview() {
        ...
        txt_add.setText("新建分类");
        txt_edit.setText("编辑与排序");
        txt_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                productListener.AddandEdit("class","add");
        ...
        txt_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                productListener.AddandEdit("class","edit");
                mPopupWindow.dismiss();
            }
        });
    }
