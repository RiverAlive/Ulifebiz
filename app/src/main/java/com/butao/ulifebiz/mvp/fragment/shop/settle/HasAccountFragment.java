 ...
 * 功能描述 ：已入账
 */
public class HasAccountFragment extends MvpFragment<AccountPresenter> implements AccountView {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mvpPresenter.loadAccount(pageNum,0+"",starttime,endTime);
        initRFView();
        return view;
    }
        ...
        recycleAdapter = new CommonRecycleAdapter<AccountModel.AccountOrder>(getActivity(),R.layout.adapter_order_account,accountOrders) {
            ...
            protected void convert(ViewHolder holder, final AccountModel.AccountOrder accountOrder, final int position) {
                if(accountOrder!=null){
                    ...
                    if (!TextUtils.isEmpty(accountOrder.getPhone())) {
                        holder.setText(R.id.txt_sentTime, accountOrder.getPhone());
                    } else {
                    ...
                    if (!TextUtils.isEmpty(accountOrder.getZipcode())) {
                        holder.setText(R.id.txt_postcode, accountOrder.getZipcode());
                    } else {
                        holder.setText(R.id.txt_postcode, "");
                    }
                    if (!TextUtils.isEmpty(accountOrder.getNote())) {
                        holder.setText(R.id.txt_remark, accountOrder.getNote());
                    } else {
