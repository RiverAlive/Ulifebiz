...
public class FileUtil {
    //错误文件存储路径
    private static final String PATH = Environment.getExternalStorageDirectory().getPath() +File.separator+ "shiyuBizError";
    ...
    //将异常写入文件
    public static void writeToSDcard(Context mContext,Throwable ex) throws IOException, PackageManager.NameNotFoundException {
        //如果没有SD卡，直接返回
        ...
        String time = new SimpleDateFormat("yyyy-MM-dd HH时mm分ss秒").format(new Date(currenttime));
