...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = ContextCompat.getDrawable(getContext(),R.mipmap.tongzhi_jiantou);
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = ContextCompat.getDrawable(getContext(), R.mipmap.tongzhi_jiantou);
        }
...
//            textExpand = "展开";
//        }
        contentTextColor = typedArray.getColor(R.styleable.ExpandableTextView_contentTextColor, ContextCompat.getColor(getContext(), R.color.font_content_50));
        contentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_contentTextSize, SizeUtils.sp2px(14));

        collapseExpandTextColor = typedArray.getColor(R.styleable.ExpandableTextView_collapseExpandTextColor, ContextCompat.getColor(getContext(), R.color.font_content_50));
        collapseExpandTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_collapseExpandTextSize, SizeUtils.sp2px(14));
    ...
    private void findViews() {
        ...
        inflater.inflate(R.layout.text_expand_collapse, this);
...
//        mTvExpandCollapse.setText(mCollapsed ? getResources().getString(R.string.expand) : getResources().getString(R.string.collapse));
    ...
    public void setText( CharSequence text) {
        mRelayout = true;
        mTvContent.setText(Html.fromHtml(String.valueOf(text)));
    ...
    public void setText(CharSequence text, int position) {
        ...
        setText(Html.fromHtml(String.valueOf(text)));
