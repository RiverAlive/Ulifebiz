package com.butao.ulifebiz.view.pullrefresh;
...
public class LoadingLayout extends FrameLayout {
	...
	public LoadingLayout(Context context, final int mode, String releaseLabel, String pullLabel, String refreshingLabel) {
		super(context);
		ViewGroup header = (ViewGroup) LayoutInflater.from(context).inflate(R.layout.pull_to_refresh, this);
		...
		switch (mode) {
			case PullToRefreshView.MODE_PULL_UP_TO_REFRESH:
				headerImage.setImageResource(R.drawable.uprefresh_arrow_recyclerview);
				break;
			case PullToRefreshView.MODE_PULL_DOWN_TO_REFRESH:
			default:
				headerImage.setImageResource(R.drawable.pullrefresh_arrow_recyclerview);
				break;
		}
	}
