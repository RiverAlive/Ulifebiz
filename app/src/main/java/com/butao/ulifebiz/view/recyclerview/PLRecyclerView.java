package com.butao.ulifebiz.view.recyclerview;
...
int ItemDecorationzSize=2;
    ...
    public PLRecyclerView(Context context, AttributeSet attrs) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.view_recyclerview, this, true);
...
public void setItemDecoration(int size){
    ItemDecorationzSize = size;
    MyItemDecoration decoration = new MyItemDecoration();
    decoration.setSize(ItemDecorationzSize);
