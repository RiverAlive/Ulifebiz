...
package com.butao.ulifebiz.view.wheelview.widget;
...
import com.butao.ulifebiz.view.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		itemsLayout.measure(MeasureSpec.makeMeasureSpec(width - 2 * PADDING+10, MeasureSpec.EXACTLY),
				MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));
