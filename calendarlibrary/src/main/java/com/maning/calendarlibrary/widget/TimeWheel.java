package com.maning.calendarlibrary.widget;
...
import com.maning.calendarlibrary.widget.adapters.NumericWheelAdapter;
import com.maning.calendarlibrary.widget.config.ScrollerConfig;
import com.maning.calendarlibrary.widget.data.source.TimeRepository;
import com.maning.calendarlibrary.widget.utils.DateConstants;
import com.maning.calendarlibrary.widget.utils.Utils;
import com.maning.calendarlibrary.widget.wheel.OnWheelChangedListener;
import com.maning.calendarlibrary.widget.wheel.WheelView;

import java.util.Calendar;

import static com.maning.calendarlibrary.widget.config.DefaultConfig.YEAR;
import static com.maning.calendarlibrary.widget.data.Type.ALL;
import static com.maning.calendarlibrary.widget.data.Type.HOURS_MINS;
import static com.maning.calendarlibrary.widget.data.Type.MONTH_DAY_HOUR_MIN;
import static com.maning.calendarlibrary.widget.data.Type.YEAR_MONTH;
import static com.maning.calendarlibrary.widget.data.Type.YEAR_MONTH_DAY;
...
class TimeWheel {
    ...
    private WheelView mYearView, mMonthView, mDayView, mHourView, mMinuteView
            , mFinishYearView,  mFinishMonthView, mFinishDayView; // 滚动视图
