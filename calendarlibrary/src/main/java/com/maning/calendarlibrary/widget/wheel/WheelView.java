...
package com.maning.calendarlibrary.widget.wheel;
...
import com.maning.calendarlibrary.widget.adapters.WheelViewAdapter;
import com.maning.calendarlibrary.widget.config.DefaultConfig;
...
//        canvas.drawLine(x, mLineRightMar, x, getHeight() - mLineRightMar, mPaintLineRight);
    ...
    void refreshTextStatus(View view, int index) {
        ...
        if (index == currentItem) {
            textView.setTextColor(getResources().getColor(selectorColor));
        } else {
            textView.setTextColor(getResources().getColor(defaultColor));
        }
    }
